...
// import "../Sidebar/Sidebar.css"; //files before refactor
...
import { auth } from "../../../firebase"; // pages/components/src/firebase
import Sidebar from "../../Sidebar/Sidebar"; // pages/components/sidebar/sidebar
import { handleSignout } from "../../../services/authHandlers"; // pages/components/src/services
import JdFromUrl from "../../Helpers/JdForm/JdFromUrl"; // pages/components/helper/JdForm/JdFromUrl
...
import ProfileExtractor from "../../Helpers/ProfileExtractor/ProfileExtractor";
import { usePdf } from "../../PdfContext";
import { useTargetedResume } from "../../TargetedResumeContext"; //NOT USING THIS (not sure if its still here) BUT IF YOU USE THIS THE IMPORT PATH INCORRECT
import { getSelectedKeywords } from "../../../services/keywordService"; // pages/components/src/services/keywordService
import TinyDiffEditor from "../../Helpers/TinyDiffEditor/TinyDiffEditor"; // pages/components/helper/tinydiffeditor/tinydiffeditor
import { fetchMasterText, getSimilarityScore, generateTargetedResumeHtml, saveGeneratedResumePdf } from "../../../services/resumeService"; // pages/components/src/services
import { resumeTextToHtml } from "../../../utils/resumeHtmlFormatter"; // pages/components/src/utils
import { toDiffHtml } from "../../../utils/diffHtml"; // pages/components/src/utils

import AOS from "aos";
import "aos/dist/aos.css"; //you may need to do "npm install aos" in frontend?? not sure about this line didn't change it, I think the import path may be wrong
import "./TailorResume.css";
import "../../Sidebar/Sidebar.css"; // pages/components/sidebar/sidebar.css
